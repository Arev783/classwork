...
// function check(val)
// {
// 	if(val == "" || val == undefined || val == 0 || val == null || val == false  || val == 0n)
// 	{
// 		return true;
// 	}
// 	return false;
...
// function check(val)
// {
// 	if(typeof val === "number" && !isNaN(val) && isFinite(val) && val <= 2**53 -1)
// 	{
// 		return true;
// 	}
// 	else{
...
// {
// 	let type = typeof(val);
// 	if(type === "number" || type === "string" ||type === "boolean" || type === "undefined" || type === "null" || type === "bigint" || type === "symbol")
// 	{
// 		return true;
// 	}
// 	else 
